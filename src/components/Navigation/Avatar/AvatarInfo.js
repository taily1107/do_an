...
export const AvatarInfo = React.memo(function ProfileCard() {
  ...
  return (
    <Card className={cx(styles.card)}>
      ...
      <Divider light />
      <Typography className={styles.subheader}>Designed by Tài Lý</Typography>
      ...
      <Box display="flex" justifyContent="center">
        <IconButton
          size="small"
          component={Link}
          href="https://www.facebook.com/ly.tai.73550"
          target="_blank"
          rel="noopener"
        >
          <FacebookIcon />
        ...
        <IconButton
          size="small"
          component={Link}
          href="https://github.com/taily123456789/cuoikhoa.git"
          target="_blank"
          rel="noopener"
        >
